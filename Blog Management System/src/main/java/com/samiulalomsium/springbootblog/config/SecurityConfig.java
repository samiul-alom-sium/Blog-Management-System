package com.samiulalomsium.springbootblog.config;

import com.samiulalomsium.springbootblog.model.User;
import com.samiulalomsium.springbootblog.service.UserService;
import com.samiulalomsium.springbootblog.util.BlogReactiveUserDetailsService;
...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain springWebFilterChain(ServerHttpSecurity http) throws Exception {
        return http
                .authorizeExchange().pathMatchers(HttpMethod.GET, "/article", "/article/show/**",
                        "/webjars/**", "/css/**", "/favicon.ico", "/").permitAll()
