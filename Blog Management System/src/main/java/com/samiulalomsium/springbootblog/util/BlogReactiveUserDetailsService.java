package com.samiulalomsium.springbootblog.util;

import com.samiulalomsium.springbootblog.model.User;
import com.samiulalomsium.springbootblog.repo.UserRepository;
...
public class BlogReactiveUserDetailsService implements ReactiveUserDetailsService {
    ...
    public Mono<UserDetails> findByUsername(String s) {
        ...
        return Mono.just(new org.springframework.security.core.userdetails.User(user.getUsername(),
